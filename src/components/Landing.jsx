        ...
        <div className="landing">
          <div className="landing-text">
            ...
            <div className="landing-buttons">
              <div className="button-hover" onClick={() => scrollDown(surveySection)}>
                <Button bgColour="#FFFFFF" borderColour="#FF6C4A" text="Apply for <br /> Early Access" />
              </div>
              <div className="button-hover" onClick={() => scrollDown(aboutSection)}>
                <Button bgColour="#FF6C4A"  borderColour="rgba(52, 52, 52, 0.0)" text="About Us" />
              </div>
            </div>
          </div>
          <img
